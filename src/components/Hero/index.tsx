            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link href="/contact">
                    <span className="relative inline-block overflow-hidden rounded-xs bg-yellow px-8 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80 gleam-effect">
                      Contact Us
                    </span>
                  </Link>
                </div>

                {/* Inline styled-jsx animation */}
                <style jsx>{`
                  .gleam-effect::before {
                    content: "";
                    position: absolute;
...
//                   Queens Tech Bros
//                 </h1>
//                 <h2 className="mb-5 text-3xl font-bold italic leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
//                   IT Solutions For Your Business
//                 </h2>
//                 <p className="mb-12 text-base leading-relaxed! text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
//                   Queens Tech Bros is free Next.js template for startups and SaaS
